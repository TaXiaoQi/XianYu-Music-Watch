...
- 🔗 **自研腕上链路协议**
  ...
  - **可靠连接**：配对地址持久化自动连接、3s 心跳、10s 无帧判死、1→15s 指数退避重连、本地 1s 进度插值。
...
- 🎵 **网易云手表式播放 UI**
  ...
  - **腕上音效**：内置多段均衡器（多预设）、混响、激励器、重低音、变速变调与空间音效，表上直接调。
...
- ☁️ **账号、歌单与云同步**
  ...
  - **弦予账号登录**：表上直接登录服务端账号（内置人机验证），收藏歌单云端同步、跨端一致。
  - **数据备份与自更新**：播放数据备份恢复；应用内检查更新，新版本表上直接装。
...
| ![功能区](应用截图-腕上端/功能区.png)<br/>功能区 | ![本地音乐](应用截图-腕上端/本地页.png)<br/>本地音乐 | ![音效](应用截图-腕上端/音效页.png)<br/>音效 |
|:---:|:---:|:---:|
